...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define pcgamgsetsymmetrizegraph_ PCGAMGSETSYMMETRIZEGRAPH
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define pcgamgsetsymmetrizegraph_ pcgamgsetsymmetrizegraph
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
PETSC_EXTERN void  pcgamgsetsymmetrizegraph_(PC pc,PetscBool *n, int *__ierr)
{
*__ierr = PCGAMGSetSymmetrizeGraph(
	(PC)PetscToPointer((pc) ),*n);
}

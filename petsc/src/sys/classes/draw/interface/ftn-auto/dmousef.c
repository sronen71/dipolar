...
extern "C" {
#endif
PETSC_EXTERN void  petscdrawgetmousebutton_(PetscDraw draw,PetscDrawButton *button,PetscReal *x_user,PetscReal *y_user,PetscReal *x_phys,PetscReal *y_phys, int *__ierr)
{

...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define dmplexlandauaddtofunction_ DMPLEXLANDAUADDTOFUNCTION
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define dmplexlandauaddtofunction_ dmplexlandauaddtofunction
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
PETSC_EXTERN void  dmplexlandauaddtofunction_(DM pack,Vec X,PetscErrorCode (*func)(DM, Vec, PetscInt, PetscInt, PetscInt, void*),void* user_ctx, int *__ierr)
{
*__ierr = DMPlexLandauAddToFunction(
